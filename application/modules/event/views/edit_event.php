...
<?php $msg = $this->session->flashdata('msg'); if((isset($msg)) && (!empty($msg))) { ?>
        ...
        <a href="#" class="close" data-dismiss="alert">&times;</a>
                ...
                <?php } ?>
		<?php echo form_open_multipart('event/update_event'); ?>
		...
		<div class="pull-left">
                <div class="form-group">
                  <label class="col-md-4 control-label">Judul event</label>
                    <div class="col-md-8" style="margin-bottom:25px;">
                      <input  type="text" name="judul" class="form-control" value="<?php echo $p->judul_event; ?>">
                    </div>
                </div>
		      <div class="form-group">
		      ...
		      <div class="form-group">
		        <div class="col-md-8">
		         ...
		         <input type="hidden" value="<?php echo $p->id_event;?>" name="id">
