...
<?php $msg = $this->session->flashdata('msg'); if((isset($msg)) && (!empty($msg))) { ?>
          ...
          <div class="box" style="padding: 15px;">
                  ...
                  <a href="<?php echo base_url();?>partner/add_partner?>" class="btn btn-primary"  style="float:right; margin-bottom: 10px;">Add partner</a><br>
                      ...
                      <tr style="border-bottom: 1px solid #666;">
                        ...
                        <td style="text-align:center;padding: 10px;">
                          <a class="btn btn-warning"  href="<?php echo base_url();?>partner/edit_partner/<?php echo $p->id_partner?>">Edit</a>
                          <a class="btn btn-danger"  href="#del_<?php echo $p->id_partner?>" data-toggle="modal">Delete</a>

                        </td>
                
                      </tr>
                        <div class="modal fade" id="del_<?php echo $p->id_partner;?>" tabindex="-1" role="dialog" aria-labelledby="addModal" aria-hidden="true" >   
                        <form action="<?php echo base_url();?>partner/delete_partner" method="post" data-parsley-validate>
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myAddLabel">Warning!</h4>
                                            ...
                                            <div class="modal-body">                
                                              ...
                                              <div align="center"> 
                                              <input type="hidden" name="id" value="<?php echo $p->id_partner;?>">
