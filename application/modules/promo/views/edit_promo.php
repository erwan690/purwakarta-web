...
<?php $msg = $this->session->flashdata('msg'); if((isset($msg)) && (!empty($msg))) { ?>
        ...
        <a href="#" class="close" data-dismiss="alert">&times;</a>
                ...
                <?php } ?>
		<?php echo form_open_multipart('promo/update_promo'); ?>
		<?php foreach($promo as  $p):?>
		<div class="pull-left">
                <div class="form-group">
                  <label class="col-md-4 control-label">Judul Promo</label>
                    <div class="col-md-8" style="margin-bottom:25px;">
                      <input  type="text" name="judul" class="form-control" value="<?php echo $p->judul_promo; ?>">
                    </div>
                </div>
		      <div class="form-group">
		      ...
		      <div class="form-group">
		        <div class="col-md-8">
		         ...
		         <input type="hidden" value="<?php echo $p->id_promo;?>" name="id">
