...
<?php $msg = $this->session->flashdata('msg'); if((isset($msg)) && (!empty($msg))) { ?>
          ...
          <div class="box" style="padding: 15px;">
                  ...
                  <a href="<?php echo base_url();?>promo/add_promosi" class="btn btn-primary"  style="float:right; margin-bottom: 10px;">Add Promo</a><br>
                      ...
                      <tr style="border-bottom: 1px solid #666;">
                        ...
                        <td style="padding: 10px;">
                            <p> <?php echo $p->judul_promo; ?> </p>
                        </td>
                        <td style="padding: 10px;">
                            <p> <?php echo $p->deskripsi; ?> </p>
                        </td>
                        <td style="text-align:center;padding: 10px;">
                          <a class="btn btn-warning"  href="<?php echo base_url();?>promo/edit_promo/<?php echo $p->id_promo?>">Edit</a>
                          <a class="btn btn-danger"  href="#del_<?php echo $p->id_promo?>" data-toggle="modal">Delete</a>

                        </td>

                      </tr>
                        <div class="modal fade" id="del_<?php echo $p->id_promo;?>" tabindex="-1" role="dialog" aria-labelledby="addModal" aria-hidden="true" >
                        <form action="<?php echo base_url();?>promo/delete_promo" method="post" data-parsley-validate>
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myAddLabel">Warning!</h4>
                                            ...
                                            <div class="modal-body">
                                              ...
                                              <div align="center">
                                              <input type="hidden" name="id" value="<?php echo $p->id_promo;?>">
